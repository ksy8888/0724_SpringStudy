...
public class StudentDAO extends SqlSessionDaoSupport {
	 ...
	 *  <select id="studentFindData" resultType="StudentVO" parameterType="string">
	     SELECT * FROM student
	     WHERE name LIKE '%'||#{name}||'%'    //name 여러개들어올수도있음
	    </select>
	 */
	...
	// 추가
	/*
	 * <insert id="studentInsert" parameterType="StudentVO">    //resultType없으니까 void
	...
	// 삭제
	/*
	 *<delete id="studentDelete" parameterType="int" resultType="int">
	    DELETE FROM student
	    WHERE hakbun=#{hakbun}
	  </delete>
	 */
