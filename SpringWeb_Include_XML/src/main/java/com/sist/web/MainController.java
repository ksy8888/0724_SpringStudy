 ...
 *                => 가급적이면 사용하지 않는다
 *                => 사용자 정의 메소드를 만들때 매개변수를 설절하면 DispatcherServlet에 의해 매개변수가 채워진다
 *                => JSP 결과값은 전송 => Model      
 *   Model을 작성
 ...
 *                @GetMapping()
 *                public String display(HttpSession session) //세션 가져옴
 ...
 *   ------------------------------------Spring 4.3 이후부터 나눠져 있다                                 
 *   @RequestMapping  => Get/Post 동시에 처리 가능
