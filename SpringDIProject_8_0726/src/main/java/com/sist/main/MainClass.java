 ...
 *                   b       new B()
 *                -----------------------
 *                *** 프로그램 동작 시작 => 클래스를 모아서 저장 : 주소값이 변경 안된다
 *                    => 싱글턴
 *             => 패키지 단위 설정
 *                <Context:component-scan base-package ="com.sist.*">
 *           ----> 단점
 *                사용자정의 / 라이브러리 클래스 (MyBatis, VooreTesolve...)
 *                         => 어노테이션이 없다 => 가급적 XML등록
 *          Annotation
 *             => 메모리 할당
 *               ---------------------------- 클래스의 종류별 구분
 ...
 *                --------------------------- 클래스에 있으면(설정을 하면) 컨테이너가 메모리를 할당한다.
 *          *** 빈(객체) 생명주기
 *            빈생성 => DI => init-method = 객체사용(개발자) = destroy-methods = 소명
 *          자바코드
 *    3. AOP의 개념
 *    3. MVC구조 파악
 *    5. 보안
...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		String path="C:\\springDev\\springStudy\\SpringDIProject_8_0726\\src\\main\\java\\com\\sist\\main\\app.xml";
