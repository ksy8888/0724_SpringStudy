...
public class SeoulRestController {
	...
	public String seoul_list(int page,int type) throws Exception { /* params: { page:this.curpage, type:this.type }*/
		Map map = new HashMap();
		int rowSize=20;
		...
		map.put("start", start);
		map.put("end", end);
		map.put("table_name", tables[type]);  //mapper.xml의 key명과 일치
