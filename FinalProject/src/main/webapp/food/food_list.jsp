	  	        ...
	  	        <table class="table" v-for="vo in food_list">
	  	         <tr>
	  	          <td width="30%" class="text-center" rowspan="4">
	  	            <a :href="'../food/food_detail_before.do?fno='+vo.fno"> <!-- v-for="vo in food_list" -->
	  	            <img :src="vo.poster" style="width: 300px;height:200px" class="img-rounded">
	  	            </a>
	  	          </td>
	  	          <td width="70%"><h4><a :href="'../food/food_detail_before.do?fno='+vo.fno">{{vo.name}}</a>&nbsp;
...
<script>
  new Vue ({
	  el:'.container',
	  data: {
		  cno: ${cno},  //foodcontroller에서 회면이 바뀔때마다 cno넘겨줌
		  food_list:[],
		  cate_info:{}
	  },
	  mounted:function() {
