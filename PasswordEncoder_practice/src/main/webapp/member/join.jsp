	   ...
	   <div class="row">
	    <table class="table">
	     <tr>
	      ...
	      <td width=80%>
	       <input type=text ref="id" size=15 class="input-sm" v-model="id"> <!-- v-model 양방향통신 -->
	      </td>
	     </tr>
	     <tr>
	     ...
	     <tr>
	      ...
	      <td width=80%>
	       ...
	       <input type=radio value="여자" ref="sex" name="sex" v-model="sex">여자	<!-- ref값읽기/name그룹 -->
	      </td>
	     </tr>
	     <tr>
	     <td colspan="2" class="text-center">
	      <input type=button value="회원가입" class="btn btn-sm btn-danger" @click="join()"><!-- @click:함수호출 -->
