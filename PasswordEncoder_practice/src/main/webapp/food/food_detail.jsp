...
<body>
  <div class="container">
   <div class="row">
    ...
    <table class="table">
      <tr>
       <td class="text-center" v-for="img in poster"> <!-- string자를때: split() -->
...
<!-- 수정 -->
             <tr style="display:none" :id="'reply'+re.no" class="updates">
              <td colspan="2">
               ...
               <input type=button value="댓글수정" style="height:66px; background-color: blue;color:white" @click="replyUpdate(re.no)">
              </td>
             </tr>
            </table>
          </td>
       ...
       <table class="table" v-if="food_detail.sessionId!=null">
         <tr>
          <td>
           ...
           <input type=button value="댓글쓰기" style="height:66px; background-color: blue;color:white" @click="replyWrite()">
          </td>
         </tr>
       </table>
     </div>
    ...
    new Vue({
    	...
    	methods: { 
    		...
    		addScript:function() {
    			...
    			script.src='https://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=9449c44c1fccbca5a237f51044d305fc&libraries=services'
    		...
    		replyUpdate:function(no) {
    			...
    			axios.post('../food/reply_update_vue.do',null, {
    				...
    				console.log(response.data)
    				this.reply_data = response.data //실행시에 변경된 data값으로 출력
    				$('#reply'+no).hide();
    				$('#up'+no).val("수정");
    				this.no=0;
