	...
	<div class="container">
	 ...
	 <div class="row">
	  <div class="text-center">
	   ...
	   <b-button variant="outline-default" @click="musicGetData(6)">재즈</b-button>
	   <b-button variant="outline-danger" @click="musicGetData(7)">클래식</b-button>
	  </div>
	 </div>
	 <div style="height: 20px"></div>
	 <div class="row">
	   <input type=text ref="fd" class="input-sm" placeholder="검색어 입력" id="keyword" v-on:keyup="selectMusic()">
	 </div>
