...
<div class="container">
 ...
 <!-- 양방향 통신: 입력값을 받아서 출력을 하는 역할  -->
  입력:<input type="text" v-model="msg" size="30" class="input-sm"><!-- id="msg" -->
  <!-- v-model => 멤버변수값을 변경 -->
...
<script>
	new Vue({
		el:'.container',   //<div class="container">...</div> 안의 전체 영역을 제어
		data: {
			msg:''
		}
	})
